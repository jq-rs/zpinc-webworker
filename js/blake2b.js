...
//exports.hash = //exports.BLAKE2b = MAX_MAX_DEPTH = MAX_FANOUT = MAX_LEAF_SIZE = SALT_LENGTH = PERSONALIZATION_LENGTH = KEY_LENGTH = DIGEST_LENGTH = BLOCK_SIZE = void 0;
...
var BLAKE2b = /** @class */ (function () {
    function BLAKE2b(digestLength, config) {
        ...
        this._buffer = new Uint8Array(BLOCK_SIZE); // buffer for data
    ...
    BLAKE2b.prototype.finish = function (out) {
        if (!this._finished) {
            for (var i = this._bufferLength; i < BLOCK_SIZE; i++) {
                this._buffer[i] = 0;
            }
            // Set last block flag.
...
//    if (digestLength === void 0) { digestLength = DIGEST_LENGTH; }
